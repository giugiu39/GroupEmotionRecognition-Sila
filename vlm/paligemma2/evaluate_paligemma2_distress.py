...
DEFAULT_EMOTIONS = (
    "neutral", "happiness", "surprise", "distress",
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--metrics_json", default="./paligemma2_distress_test_metrics.json")
...
def build_report(
    ...
    metrics["metadata"] = {
        ...
        "status": status,
        "model": args.model_id,
        "mode": "base_no_adapter_distress_classes",
